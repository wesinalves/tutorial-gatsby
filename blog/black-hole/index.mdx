...
Cada telescópio do EHT capturam os dados gerados pelo buraco negro. Através dos
algoritmos computacionais e astrofísicos os ruídos são removidos, os dados são calibrados
e preparados para a próxima etapa. Após isso, o processo de análise, simulação 
e geração da imagem é realizado usando o pacote *eht-imaging*, que será detalhado
mais adiante.
