...
category: AI/ML
color: info
description: Entenda como Python ajudou a gerar a primeira imagem de um buraco negro.
...
e preparados para a próxima etapa removendo os ruídos causados pelo clima. 
...
# colocar imagem do kip thorne ok
# critério para se formar um buraco negro 
# nome dos centros de pesquisa ok
# dividir a metodologia em slides separados ok
# melhorar a resolução das imagens ok
# mapear as ferramentas com suas funcionalidades ok
# fazer correlação com o artigo ok
# imagem das bibliotecas ok
# melhorar imagem da metodologia