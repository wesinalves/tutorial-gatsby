...
color: info
category: MIX
description: Nesse post vou apresentar qual é a minha rotina como engenheiro da computação dividindo-a em sete atividades
...
---
![engenheiro-da-computação](./computerengineer.png)
...
![rotina-engenheiro-da-computação](./rotina-de-um-engenheiro-da-computacao.png)
