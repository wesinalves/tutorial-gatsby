...
category: AI/ML
color: info
description: Este guia explica como instalar o TensorFlow no Repberry Pi
hero_image: "./install_tensorflow_on_raspberry_pi.jpg"
...
---
![respbian](./install_tensorflow_on_raspberry_pi.jpg)
