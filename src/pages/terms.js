        ...
        <Layout pageTitle="Política de Privacidade">
            ...
            <Container disableGutters maxWidth="md" component="main" >
                ...
                <Box>
                    ...
                    (informações ou software) no site wesinribeiro.com , apenas para visualização transitória pessoal 
                    ...
                    poderá ser rescindida por wesinribeiro.com a qualquer momento. Ao encerrar a visualização desses 
                    ...
                    <ol> <li>Os materiais no site da wesinribeiro.com são fornecidos 'como estão'. wesinribeiro.com 
                    ...
                    direitos. </li>            
                    <li>Além disso, o wesinribeiro.com não garante ou faz qualquer representação relativa à precisão, 
                    ...
                    <h2>4. Limitações</h2>            
                    <p>Em nenhum caso o wesinribeiro.com ou seus fornecedores serão responsáveis ​​por quaisquer danos 
                    (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) 
                    decorrentes do uso ou da incapacidade de usar os materiais em wesinribeiro.com,                
                    mesmo que wesinribeiro.com ou um representante autorizado da wesinribeiro.com tenha sido notificado 
                    ...
                    <p>Os materiais exibidos no site da wesinribeiro.com podem incluir erros técnicos, tipográficos ou 
                    fotográficos. wesinribeiro.com não garante que qualquer material em seu site seja preciso, 
                    completo ou atual. wesinribeiro.com pode fazer alterações nos materiais contidos em seu 
                    site a qualquer momento, sem aviso prévio. No entanto, wesinribeiro.com não se compromete a 
                    atualizar os materiais.</p>            
                    <h2>6. Links</h2>            
                    <p>O wesinribeiro.com não analisou todos os sites vinculados ao seu site e não é responsável 
                    pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por 
                    wesinribeiro.com do site. O uso de qualquer site vinculado é por conta e risco do usuário.</p>
                    <h3>Modificações</h3>            
                    <p>O wesinribeiro.com pode revisar estes termos de serviço do site a qualquer momento, 
                    sem aviso prévio. Ao usar este site, você concorda em ficar vinculado à versão atual desses 
                    termos de serviço.</p>            
                    <h3>Lei aplicável</h3>            
                    <p>Estes termos e condições são regidos e interpretados de acordo com as leis do wesinribeiro.com 
